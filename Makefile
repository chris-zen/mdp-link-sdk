PROJECT_NAME     := mdp-link
TARGETS          := nrf52840_xxaa
OUTPUT_DIRECTORY := _build

MDK_ROOT := ../nrf52840-mdk
SDK_ROOT := $(MDK_ROOT)/nrf_sdks/nRF5_SDK_15.3.0_59ac345
PROJ_DIR := .


$(OUTPUT_DIRECTORY)/nrf52840_xxaa.out: \
  LINKER_SCRIPT  := nrf52-mdp-link.ld
...
copy: default
	...
	cp $(OUTPUT_DIRECTORY)/nrf52840_xxaa.hex $(PROJ_DIR)/$(PROJECT_NAME).hex
